package ex12_Inheritance.ex03_Polymorphism;
...
public class Main {
  public static void main(String[] args) {
    ...
    coffee1.taste();  // 코드 작성 시에는 Coffee의 taste()를 연결(정적 바인딩)하지만, 실행 시에는 Espresso의 taste()를 연결한다.(동적 바인딩)
    coffee2.taste();
